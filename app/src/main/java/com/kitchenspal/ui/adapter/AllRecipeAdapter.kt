...
class AllRecipeAdapter : RecyclerView.Adapter<AllRecipeAdapter.RecipeViewHolder>() {
    ...
    inner class RecipeViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val recipeTitle: TextView = itemView.findViewById(R.id.allTitle)
        private val recipeImage: ImageView = itemView.findViewById(R.id.allImage)
